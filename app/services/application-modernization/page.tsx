...
const appModMetadata = {
  ...
  title: "Modernize Your Applications with Technosive's Expertise",
  description:
    "Upgrade your legacy systems with Technosive's application modernization services. We specialize in transforming outdated applications into modern, efficient solutions. Benefit from enhanced performance, scalability, and maintainability with our tailored modernization strategies and cutting-edge technologies.",
  keywords: [
    "Technosive",
    "Modernization",
    "Upgrade",
